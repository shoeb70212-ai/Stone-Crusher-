  ...
  return (
    <form onSubmit={handleUpdate} className="p-4 md:p-5 space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="space-y-1">
          <label className="text-sm font-medium text-zinc-700 dark:text-zinc-200">Material</label>
          <select
        ...
        <div className="space-y-1">
          ...
          >
            ...
            <option value="Weight (Tonnes)">Weight (Tonnes)</option>
          </select>
        </div>
      </div>
      ...
      {formData.measurementType === "Volume (Brass)" ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            <label className="text-sm font-medium text-zinc-700 dark:text-zinc-200">Gross Wt (T)</label>
          ...
          <div className="space-y-1">
            <label className="text-sm font-medium text-zinc-700 dark:text-zinc-200">Tare Wt (T)</label>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="space-y-1">
          <label className="text-sm font-medium text-zinc-700 dark:text-zinc-200">Customer</label>
          <Combobox
         ...
         <div className="space-y-1">
          <label className="text-sm font-medium text-zinc-700 dark:text-zinc-200">Rate ₹</label>
          <input
            required
            type="number"
            min="0"
