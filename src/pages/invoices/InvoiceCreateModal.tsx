  ...
  return (
    ...
    >
      <div className="p-2 space-y-3">
        ...
        {newInvoice.customerId && newInvoice.customerId !== "CASH" && (
          <div className="border border-zinc-200 dark:border-zinc-700 rounded-lg overflow-hidden">
            <div className="bg-zinc-50 dark:bg-zinc-900/50 px-2 py-2 border-b border-zinc-200 dark:border-zinc-700 flex justify-between items-center">
              <div className="flex items-center gap-2">
                <span className="font-semibold text-xs text-zinc-700 dark:text-zinc-200">Select Slips</span>
                <span className="text-[9px] text-zinc-400 dark:text-zinc-500 font-medium">• details print on page 2</span>
              ...
              {unbilledSlips.length > 0 && (
                <button
                  ...
                  className="text-xs bg-primary-600 hover:bg-primary-700 disabled:opacity-40 text-white px-3 py-1.5 rounded-lg transition-colors font-medium shadow-sm"
                >
                  Generate Items
                </button>
              )}
            ...
            {unbilledSlips.length === 0 ? (
              <div className="p-4 text-center bg-white dark:bg-zinc-800">
                <p className="text-xs text-zinc-400 dark:text-zinc-500">No tallied slips available for this customer</p>
              </div>
            ) : (
